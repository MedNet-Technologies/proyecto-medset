...
export declare type HttpResponsePartial = {
...
export interface FetchMockAPI {
     ...
     */
    mockResponse: (responseObject?: HttpResponsePartial, queueItem?: FetchMockQueueItem | JestMockPromise, silentMode?: boolean) => HttpResponse | undefined;
    /**
     ...
     *   only fail quietly if no matching request is found.
     */
    mockError: (error?: any, queueItem?: FetchMockQueueItem | JestMockPromise, silentMode?: boolean) => void;
    /**
 ...
 */
export declare type FetchMockType = FetchMockAPI & jest.Mock<JestMockPromise, [string, any?, any?]>;
